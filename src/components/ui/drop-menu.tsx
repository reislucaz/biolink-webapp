...
export const CustomDropdownMenu: React.FC<CustomDropdownMenuProps> = ({ children, profileType }) => {
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Content className="bg-card text-card-foreground rounded-md shadow-lg p-2">
        ...
        <DropdownMenu.Item className="p-2 hover:bg-muted hover:text-muted-foreground cursor-pointer flex items-center gap-2">
